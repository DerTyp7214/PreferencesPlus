...
import com.dertyp7214.preferencesplus.core.saturate
    ...
    XYZ {
        ...
        override fun calcColor(bars: List<Int>): Int {
            return ColorUtils.XYZToColor(
                    calcValue(95.047F, bars[1]).apply { Log.d("X", this.toString()) }.toDouble(),
                    calcValue(100F, bars[2]).apply { Log.d("Y", this.toString()) }.toDouble(),
                    calcValue(108.883F, bars[3]).apply { Log.d("Z", this.toString()) }.toDouble()
            ).apply {
